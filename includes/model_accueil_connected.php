...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container-fluid d-flex">
      ...
      <nav class="nav-menu d-none d-lg-block">
        <ul>
          <li class="get-started"><a href="#about" id="créer">Se déconnecter</a></li>
          <li class="get-started"><a href="#about" id = "monprofil">Mon Profil</a></li>
          <li class="get-started"><a href="#about" id="stages">Stages</a></li>
  ...
  <div class="s010">
    <form id="form1" action="search.inc.php" method="get">
      <?php
